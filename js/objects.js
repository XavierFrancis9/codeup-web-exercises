(function() {
    ...
    shoppers.forEach((element) => {
        element.discount = shopperDiscount(element.amount);
    });

    console.log(shoppers);

    shoppers.forEach((element) => {
        element.total = (element.amount * (1 - parseInt(element.discount) * .01));
    })
    ...
    let newBooks = [
        createBook("Cool Book", "John", "Smith"),
        createBook("Awesome Book", "Dude", "Guy"),
